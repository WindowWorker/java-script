  ...
  res.removeHeader('content-length');
    ...
    if ((ct) && (!ct.includes('image')) && (!ct.includes('video')) && (!ct.includes('audio'))) {
      ...
      if(resBody.includes('</body>')){
        ...
        resBody='<html>'+resBody+resBody2.replace(' id="main"',' id="main2"').replaceAll('script','style')+'<style>main:nth-of-type(n + 2),footer:nth-of-type(n + 2),html[window-location*="/docs"]>body>main{display:none;}</style></html>';
      }
